...
impl Scb {
    ...
    #[inline(always)]
    #[doc = "CPUID"]
    pub const fn cpuid(&self) -> utils::Reg<fields::Cpuid, utils::RO> {
        unsafe {
            let ptr = self.ptr.add(0x0);
            <utils::Reg<fields::Cpuid, utils::RO>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "Interrupt control and state register"]
    pub const fn icsr(&self) -> utils::Reg<fields::Icsr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x4);
            <utils::Reg<fields::Icsr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    ...
    pub const fn aircr(&self) -> utils::Reg<fields::Aircr, utils::RO> {
        unsafe {
            let ptr = self.ptr.add(0xc);
            <utils::Reg<fields::Aircr, utils::RO>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "System control register"]
    pub const fn scr(&self) -> utils::Reg<fields::Scr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x10);
            <utils::Reg<fields::Scr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    ...
    pub const fn shpr1(&self) -> utils::Reg<fields::Shpr1, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x18);
            <utils::Reg<fields::Shpr1, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "System handler priority register 2"]
    pub const fn shpr2(&self) -> utils::Reg<fields::Shpr2, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x1c);
            <utils::Reg<fields::Shpr2, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "System handler priority register 3"]
    pub const fn shpr3(&self) -> utils::Reg<fields::Shpr3, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x20);
            <utils::Reg<fields::Shpr3, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "System handler control and state register"]
    pub const fn shcrs(&self) -> utils::Reg<fields::Shcrs, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x24);
            <utils::Reg<fields::Shcrs, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "Configurable fault status register"]
    pub const fn cfsr(&self) -> utils::Reg<fields::Cfsr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x28);
            <utils::Reg<fields::Cfsr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "HardFault status register"]
    pub const fn hfsr(&self) -> utils::Reg<fields::Hfsr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x2c);
            <utils::Reg<fields::Hfsr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
