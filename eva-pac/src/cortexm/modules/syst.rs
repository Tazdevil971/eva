...
impl Syst {
    ...
    pub const fn rvr(&self) -> utils::Reg<fields::Rvr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x4);
            <utils::Reg<fields::Rvr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "SysTick current value register"]
    pub const fn cvr(&self) -> utils::Reg<fields::Cvr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x8);
            <utils::Reg<fields::Cvr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "SysTick calibration value register"]
    pub const fn calib(&self) -> utils::Reg<fields::Calib, utils::RO> {
        unsafe {
            let ptr = self.ptr.add(0xc);
            <utils::Reg<fields::Calib, utils::RO>>::from_ptr(ptr)
        }
    }
}
pub mod fields {
    ...
    impl Csr {
        ...
        pub const fn set_clksource(mut self, val: vals::Clksource) -> Self {
            self.bits &= !(0x1 << 0x2);
        ...
        #[inline(always)]
        #[doc = "Indicates the clock source"]
        pub const fn clksource(self) -> vals::Clksource {
            let val = ((self.bits >> 0x2) & 0x1) as _;
            unsafe { vals::Clksource::from_bits_unchecked(val) }
        }
        #[inline(always)]
