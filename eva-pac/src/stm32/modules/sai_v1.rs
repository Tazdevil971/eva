...
impl Ch {
    ...
    pub const fn frcr(&self) -> utils::Reg<fields::Frcr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x8);
            <utils::Reg<fields::Frcr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "This register has no meaning in AC97 and SPDIF audio protocol"]
    pub const fn slotr(&self) -> utils::Reg<fields::Slotr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0xc);
            <utils::Reg<fields::Slotr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "Interrupt mask register 2"]
    pub const fn im(&self) -> utils::Reg<fields::Im, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x10);
            <utils::Reg<fields::Im, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "Status register"]
    ...
    pub const fn clrfr(&self) -> utils::Reg<fields::Clrfr, utils::WO> {
        unsafe {
            let ptr = self.ptr.add(0x18);
            <utils::Reg<fields::Clrfr, utils::WO>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "Data register"]
...
pub mod fields {
    ...
    impl Cr1 {
        ...
        pub const fn set_prtcfg(mut self, val: vals::Prtcfg) -> Self {
            self.bits &= !(0x3 << 0x2);
        ...
        pub const fn prtcfg(self) -> vals::Prtcfg {
            ...
            unsafe { vals::Prtcfg::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_ds(mut self, val: vals::Ds) -> Self {
            self.bits &= !(0x7 << 0x5);
        ...
        pub const fn ds(self) -> vals::Ds {
            ...
            unsafe { vals::Ds::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_ckstr(mut self, val: vals::Ckstr) -> Self {
            self.bits &= !(0x1 << 0x9);
        ...
        pub const fn ckstr(self) -> vals::Ckstr {
            ...
            unsafe { vals::Ckstr::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_syncen(mut self, val: vals::Syncen) -> Self {
            self.bits &= !(0x3 << 0xa);
        ...
        pub const fn syncen(self) -> vals::Syncen {
            ...
            unsafe { vals::Syncen::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_mono(mut self, val: vals::Mono) -> Self {
            self.bits &= !(0x1 << 0xc);
        ...
        pub const fn mono(self) -> vals::Mono {
            ...
            unsafe { vals::Mono::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_outdriv(mut self, val: vals::Outdriv) -> Self {
            self.bits &= !(0x1 << 0xd);
        ...
        pub const fn outdriv(self) -> vals::Outdriv {
            ...
            unsafe { vals::Outdriv::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_nodiv(mut self, val: vals::Nodiv) -> Self {
            self.bits &= !(0x1 << 0x13);
        ...
        #[inline(always)]
        #[doc = "No fixed divider between MCLK and FS"]
        pub const fn nodiv(self) -> vals::Nodiv {
            let val = ((self.bits >> 0x13) & 0x1) as _;
            unsafe { vals::Nodiv::from_bits_unchecked(val) }
        }
        #[inline(always)]
    ...
    impl Cr2 {
        ...
        pub const fn set_muteval(mut self, val: vals::Muteval) -> Self {
            self.bits &= !(0x1 << 0x6);
        ...
        pub const fn muteval(self) -> vals::Muteval {
            ...
            unsafe { vals::Muteval::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_cpl(mut self, val: vals::Cpl) -> Self {
            self.bits &= !(0x1 << 0xd);
            self.bits |= (val.to_bits() as u32 & 0x1) << 0xd;
            self
        }
        ...
        pub const fn cpl(self) -> vals::Cpl {
            let val = ((self.bits >> 0xd) & 0x1) as _;
            unsafe { vals::Cpl::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_comp(mut self, val: vals::Comp) -> Self {
            self.bits &= !(0x3 << 0xe);
        ...
        pub const fn comp(self) -> vals::Comp {
            ...
            unsafe { vals::Comp::from_bits_unchecked(val) }
        }
    }
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
    #[repr(transparent)]
    ...
    impl Frcr {
        ...
        pub const fn set_fspol(mut self, val: vals::Fspol) -> Self {
            self.bits &= !(0x1 << 0x11);
        ...
        pub const fn fspol(self) -> vals::Fspol {
            ...
            unsafe { vals::Fspol::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_fsoff(mut self, val: vals::Fsoff) -> Self {
            self.bits &= !(0x1 << 0x12);
        ...
        pub const fn fsoff(self) -> vals::Fsoff {
            ...
            unsafe { vals::Fsoff::from_bits_unchecked(val) }
        }
    }
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
    #[repr(transparent)]
    ...
    impl Slotr {
        ...
        pub const fn set_slotsz(mut self, val: vals::Slotsz) -> Self {
            self.bits &= !(0x3 << 0x6);
        ...
        pub const fn slotsz(self) -> vals::Slotsz {
            ...
            unsafe { vals::Slotsz::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_sloten(mut self, val: vals::Sloten) -> Self {
        ...
        #[inline(always)]
        #[doc = "Slot enable. These bits are set and cleared by software. Each SLOTEN bit corresponds to a slot position from 0 to 15 (maximum 16 slots). The slot must be enabled when the audio block is disabled. They are ignored in AC97 or SPDIF mode."]
        pub const fn sloten(self) -> vals::Sloten {
            let val = ((self.bits >> 0x10) & 0xffff) as _;
            unsafe { vals::Sloten::from_bits_unchecked(val) }
        }
    }
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
    #[repr(transparent)]
    ...
    impl Sr {
        ...
        pub const fn set_wckcfg(mut self, val: vals::Wckcfg) -> Self {
            self.bits &= !(0x1 << 0x2);
        ...
        #[inline(always)]
        #[doc = "Wrong clock configuration flag. This bit is read only. This bit is used only when the audio block operates in master mode (MODE[1] = 0) and NODIV = 0. It can generate an interrupt if WCKCFGIE bit is set in SAI_xIM register. This flag is cleared when the software sets CWCKCFG bit in SAI_xCLRFR register."]
        pub const fn wckcfg(self) -> vals::Wckcfg {
            let val = ((self.bits >> 0x2) & 0x1) as _;
            unsafe { vals::Wckcfg::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_cnrdy(mut self, val: vals::Cnrdy) -> Self {
            self.bits &= !(0x1 << 0x4);
        ...
        #[inline(always)]
        #[doc = "Codec not ready. This bit is read only. This bit is used only when the AC97 audio protocol is selected in the SAI_xCR1 register and configured in receiver mode. It can generate an interrupt if CNRDYIE bit is set in SAI_xIM register. This flag is cleared when the software sets CCNRDY bit in SAI_xCLRFR register."]
        pub const fn cnrdy(self) -> vals::Cnrdy {
            let val = ((self.bits >> 0x4) & 0x1) as _;
            unsafe { vals::Cnrdy::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_flvl(mut self, val: vals::Flvl) -> Self {
            self.bits &= !(0x7 << 0x10);
        ...
        #[inline(always)]
        #[doc = "FIFO level threshold. This bit is read only. The FIFO level threshold flag is managed only by hardware and its setting depends on SAI block configuration (transmitter or receiver mode). If the SAI block is configured as transmitter: If SAI block is configured as receiver:"]
        pub const fn flvl(self) -> vals::Flvl {
            let val = ((self.bits >> 0x10) & 0x7) as _;
            unsafe { vals::Flvl::from_bits_unchecked(val) }
        }
    }
}
pub mod vals {
