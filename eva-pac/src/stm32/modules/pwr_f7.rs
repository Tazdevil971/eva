...
impl Pwr {
    ...
    pub const fn csr1(&self) -> utils::Reg<fields::Csr1, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x4);
            <utils::Reg<fields::Csr1, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "power control register"]
    ...
    #[inline(always)]
    #[doc = "power control/status register"]
    pub const fn csr2(&self) -> utils::Reg<fields::Csr2, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0xc);
            <utils::Reg<fields::Csr2, utils::RW>>::from_ptr(ptr)
        }
    }
}
pub mod fields {
    ...
    impl Cr1 {
        ...
        pub const fn set_pdds(mut self, val: vals::Pdds) -> Self {
            self.bits &= !(0x1 << 0x1);
        ...
        #[inline(always)]
        #[doc = "Power down deepsleep"]
        pub const fn pdds(self) -> vals::Pdds {
            let val = ((self.bits >> 0x1) & 0x1) as _;
            unsafe { vals::Pdds::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_vos(mut self, val: vals::Vos) -> Self {
            self.bits &= !(0x3 << 0xe);
        ...
        #[inline(always)]
        #[doc = "Regulator voltage scaling output selection"]
        pub const fn vos(self) -> vals::Vos {
            let val = ((self.bits >> 0xe) & 0x3) as _;
            unsafe { vals::Vos::from_bits_unchecked(val) }
        }
        #[inline(always)]
