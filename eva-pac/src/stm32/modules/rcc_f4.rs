...
impl Rcc {
    ...
    pub const fn ckgatenr(&self) -> utils::Reg<CkgatenrBits, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x90);
            <utils::Reg<CkgatenrBits, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
...
impl Ahb1enrBits {
    ...
    pub const fn set_ccmdataramen(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x14);
...
impl Ahb2lpenrBits {
    ...
    pub const fn set_fsmclpen(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x0);
        self.bits |= if val { 1 << 0x0 } else { 0 };
        self
    }
...
impl Ahb3enrBits {
    ...
    #[inline(always)]
    #[doc = "Flexible static memory controller module clock enable"]
    pub const fn set_fsmcen(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x0);
        self.bits |= if val { 1 << 0x0 } else { 0 };
        self
    }
...
impl Ahb3rstrBits {
    ...
    #[inline(always)]
    #[doc = "Flexible static memory controller module reset"]
    pub const fn set_fsmcrst(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x0);
        self.bits |= if val { 1 << 0x0 } else { 0 };
        self
    }
...
impl Apb1lpenrBits {
    ...
    pub const fn set_spdiflpen(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x10);
        self.bits |= if val { 1 << 0x10 } else { 0 };
        self
    }
...
impl Apb2enrBits {
    ...
    pub const fn set_uart9en(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x6);
        self.bits |= if val { 1 << 0x6 } else { 0 };
        self
    }
    ...
    pub const fn set_uart10en(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x7);
        self.bits |= if val { 1 << 0x7 } else { 0 };
        self
    }
    ...
    #[inline(always)]
    #[doc = "DFSDMEN"]
    pub const fn set_dfsdmen(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x18);
        self.bits |= if val { 1 << 0x18 } else { 0 };
        self
    }
    ...
    pub const fn set_dfsdm2en(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x19);
        self.bits |= if val { 1 << 0x19 } else { 0 };
        self
    }
...
impl Apb2lpenrBits {
    ...
    pub const fn set_uart9lpen(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x6);
        self.bits |= if val { 1 << 0x6 } else { 0 };
        self
    }
    ...
    pub const fn set_uart10lpen(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x7);
        self.bits |= if val { 1 << 0x7 } else { 0 };
        self
    }
    ...
    #[inline(always)]
    #[doc = "DFSDMLPEN"]
    pub const fn set_dfsdmlpen(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x18);
        self.bits |= if val { 1 << 0x18 } else { 0 };
        self
    }
    ...
    pub const fn set_dfsdm2lpen(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x19);
        self.bits |= if val { 1 << 0x19 } else { 0 };
        self
    }
...
impl Apb2rstrBits {
    ...
    #[inline(always)]
    #[doc = "UART9 reset"]
    pub const fn set_uart9rst(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x6);
        self.bits |= if val { 1 << 0x6 } else { 0 };
        self
    }
    ...
    #[inline(always)]
    #[doc = "UART10 reset"]
    pub const fn set_uart10rst(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x7);
        self.bits |= if val { 1 << 0x7 } else { 0 };
        self
    }
    ...
    #[inline(always)]
    #[doc = "SDIO reset"]
    pub const fn set_sdiorst(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0xb);
        self.bits |= if val { 1 << 0xb } else { 0 };
        self
    }
    ...
    #[inline(always)]
    #[doc = "DFSDMRST"]
    pub const fn set_dfsdmrst(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x18);
        self.bits |= if val { 1 << 0x18 } else { 0 };
        self
    }
    ...
    #[inline(always)]
    #[doc = "DFSDM2 reset"]
    pub const fn set_dfsdm2rst(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x19);
        self.bits |= if val { 1 << 0x19 } else { 0 };
        self
    }
...
impl BdcrBits {
    ...
    #[inline(always)]
    #[doc = "External low-speed oscillator bypass"]
    pub const fn set_lsemod(mut self, val: LsemodVal) -> Self {
        self.bits &= !(0x1 << 0x3);
    ...
    #[inline(always)]
    #[doc = "External low-speed oscillator bypass"]
    pub const fn lsemod(self) -> LsemodVal {
        let val = ((self.bits >> 0x3) & 0x1) as _;
        unsafe { LsemodVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
...
impl CfgrBits {
    ...
    pub const fn set_i2ssrc(mut self, val: I2ssrcCfgrVal) -> Self {
        self.bits &= !(0x1 << 0x17);
    ...
    #[inline(always)]
    #[doc = "I2S clock selection"]
    pub const fn i2ssrc(self) -> I2ssrcCfgrVal {
        let val = ((self.bits >> 0x17) & 0x1) as _;
        unsafe { I2ssrcCfgrVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    #[doc = "MCO1 prescaler"]
...
#[repr(transparent)]
#[doc = "clocks gated enable register"]
pub struct CkgatenrBits {
    bits: u32,
}
impl Default for CkgatenrBits {
    fn default() -> Self {
        unsafe { Self::from_bits_unchecked(0x0) }
    }
}
impl CkgatenrBits {
    ...
    pub const fn set_ahb2apb1_cken(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x0);
        self.bits |= if val { 1 << 0x0 } else { 0 };
        self
    }
    ...
    pub const fn set_ahb2apb2_cken(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x1);
        self.bits |= if val { 1 << 0x1 } else { 0 };
        self
    }
    ...
    pub const fn set_cm4dbg_cken(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x2);
        self.bits |= if val { 1 << 0x2 } else { 0 };
        self
    }
    ...
    pub const fn set_spare_cken(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x3);
        self.bits |= if val { 1 << 0x3 } else { 0 };
        self
    }
    ...
    pub const fn set_sram_cken(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x4);
        self.bits |= if val { 1 << 0x4 } else { 0 };
        self
    }
    ...
    pub const fn set_flash_cken(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x5);
        self.bits |= if val { 1 << 0x5 } else { 0 };
        self
    }
    ...
    pub const fn set_rcc_cken(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x6);
        self.bits |= if val { 1 << 0x6 } else { 0 };
        self
    }
    ...
    pub const fn set_evtcl_cken(mut self, val: bool) -> Self {
        self.bits &= !(0x1 << 0x7);
        self.bits |= if val { 1 << 0x7 } else { 0 };
        self
    }
...
impl DckcfgrBits {
    ...
    pub const fn set_plli2sdivr(mut self, val: Plli2sdivrVal) -> Self {
        self.bits &= !(0x1f << 0x0);
        self.bits |= (val.to_bits() as u32 & 0x1f) << 0x0;
        self
    }
    #[inline(always)]
    #[doc = "PLLI2S division factor for SAI1 A/B clock"]
    pub const fn plli2sdivr(self) -> Plli2sdivrVal {
        let val = ((self.bits >> 0x0) & 0x1f) as _;
        unsafe { Plli2sdivrVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    #[doc = "PLL division factor for SAI1 A/B clock"]
    pub const fn set_plldivr(mut self, val: PlldivrVal) -> Self {
        self.bits &= !(0x1f << 0x8);
    ...
    #[inline(always)]
    #[doc = "PLL division factor for SAI1 A/B clock"]
    pub const fn plldivr(self) -> PlldivrVal {
        let val = ((self.bits >> 0x8) & 0x1f) as _;
        unsafe { PlldivrVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    ...
    pub const fn set_ckdfsdm2asel(mut self, val: CkdfsdmaselVal) -> Self {
        self.bits &= !(0x1 << 0xe);
    ...
    #[inline(always)]
    #[doc = "DFSDM2 audio clock selection"]
    pub const fn ckdfsdm2asel(self) -> CkdfsdmaselVal {
        let val = ((self.bits >> 0xe) & 0x1) as _;
        unsafe { CkdfsdmaselVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    #[doc = "DFSDM1 audio clock selection"]
    pub const fn set_ckdfsdm1asel(mut self, val: CkdfsdmaselVal) -> Self {
        self.bits &= !(0x1 << 0xf);
    ...
    #[inline(always)]
    #[doc = "DFSDM1 audio clock selection"]
    pub const fn ckdfsdm1asel(self) -> CkdfsdmaselVal {
    ...
    pub const fn set_sai1asrc(mut self, val: SaiasrcVal) -> Self {
        self.bits &= !(0x3 << 0x14);
    ...
    #[inline(always)]
    #[doc = "SAI1-A clock source selection"]
    pub const fn sai1asrc(self) -> SaiasrcVal {
        let val = ((self.bits >> 0x14) & 0x3) as _;
        unsafe { SaiasrcVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    #[doc = "SAI1 clock source selection"]
    pub const fn set_sai1src(mut self, val: Sai1srcVal) -> Self {
        self.bits &= !(0x3 << 0x14);
        self.bits |= (val.to_bits() as u32 & 0x3) << 0x14;
        self
    }
    #[inline(always)]
    #[doc = "SAI1 clock source selection"]
    pub const fn sai1src(self) -> Sai1srcVal {
        let val = ((self.bits >> 0x14) & 0x3) as _;
        unsafe { Sai1srcVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    #[doc = "SAI1-B clock source selection"]
    pub const fn set_sai1bsrc(mut self, val: SaibsrcVal) -> Self {
        self.bits &= !(0x3 << 0x16);
    ...
    #[inline(always)]
    #[doc = "SAI1-B clock source selection"]
    pub const fn sai1bsrc(self) -> SaibsrcVal {
        let val = ((self.bits >> 0x16) & 0x3) as _;
        unsafe { SaibsrcVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    #[doc = "SAI2 clock source selection"]
    pub const fn set_sai2src(mut self, val: Sai2srcVal) -> Self {
        self.bits &= !(0x3 << 0x16);
        self.bits |= (val.to_bits() as u32 & 0x3) << 0x16;
        self
    }
    #[inline(always)]
    #[doc = "SAI2 clock source selection"]
    pub const fn sai2src(self) -> Sai2srcVal {
        let val = ((self.bits >> 0x16) & 0x3) as _;
        unsafe { Sai2srcVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    ...
    pub const fn set_i2s1src(mut self, val: I2s1srcVal) -> Self {
        self.bits &= !(0x3 << 0x19);
    ...
    #[inline(always)]
    #[doc = "I2S APB1 clocks source selection (I2S2/3)"]
    pub const fn i2s1src(self) -> I2s1srcVal {
        let val = ((self.bits >> 0x19) & 0x3) as _;
        unsafe { I2s1srcVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    #[doc = "I2SSRC"]
    pub const fn set_i2ssrc(mut self, val: I2ssrcDckcfgrVal) -> Self {
        self.bits &= !(0x3 << 0x19);
        self.bits |= (val.to_bits() as u32 & 0x3) << 0x19;
        self
    }
    #[inline(always)]
    #[doc = "I2SSRC"]
    pub const fn i2ssrc(self) -> I2ssrcDckcfgrVal {
        let val = ((self.bits >> 0x19) & 0x3) as _;
        unsafe { I2ssrcDckcfgrVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    ...
    pub const fn set_i2s2src(mut self, val: I2s1srcVal) -> Self {
        self.bits &= !(0x3 << 0x1b);
        self.bits |= (val.to_bits() as u32 & 0x3) << 0x1b;
        self
    }
    #[inline(always)]
    #[doc = "I2S APB2 clocks source selection (I2S1/4/5)"]
    pub const fn i2s2src(self) -> I2s1srcVal {
        let val = ((self.bits >> 0x1b) & 0x3) as _;
        unsafe { I2s1srcVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    #[doc = "SDIO clock source selection"]
    pub const fn set_sdiosel(mut self, val: SdioselVal) -> Self {
        self.bits &= !(0x1 << 0x1c);
    ...
    #[inline(always)]
    #[doc = "SDIO clock source selection"]
    pub const fn sdiosel(self) -> SdioselVal {
        let val = ((self.bits >> 0x1c) & 0x1) as _;
        unsafe { SdioselVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    ...
    pub const fn set_ckdfsdm1sel(mut self, val: CkdfsdmselVal) -> Self {
        self.bits &= !(0x1 << 0x1f);
    ...
    #[inline(always)]
    #[doc = "DFSDM1 Kernel clock selection"]
    pub const fn ckdfsdm1sel(self) -> CkdfsdmselVal {
        let val = ((self.bits >> 0x1f) & 0x1) as _;
        unsafe { CkdfsdmselVal::from_bits_unchecked(val) }
    }
}
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[repr(transparent)]
...
impl Dckcfgr2Bits {
    ...
    pub const fn set_spdifrxsel(mut self, val: SpdifrxselVal) -> Self {
        self.bits &= !(0x1 << 0x1d);
        self.bits |= (val.to_bits() as u32 & 0x1) << 0x1d;
        self
    }
    #[inline(always)]
    #[doc = "SPDIF clock selection"]
    pub const fn spdifrxsel(self) -> SpdifrxselVal {
        let val = ((self.bits >> 0x1d) & 0x1) as _;
        unsafe { SpdifrxselVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    #[doc = "LPTIM1SEL"]
...
impl Plli2scfgrBits {
    ...
    pub const fn set_plli2ssrc(mut self, val: Plli2ssrcVal) -> Self {
        self.bits &= !(0x1 << 0x16);
        self.bits |= (val.to_bits() as u32 & 0x1) << 0x16;
        self
    }
    #[inline(always)]
    #[doc = "PLLI2S entry clock source"]
    pub const fn plli2ssrc(self) -> Plli2ssrcVal {
        let val = ((self.bits >> 0x16) & 0x1) as _;
        unsafe { Plli2ssrcVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    #[doc = "Main PLL(PLL) and audio PLL (PLLI2S) entry clock source"]
    pub const fn set_pllsrc(mut self, val: PllsrcVal) -> Self {
