...
impl Rcc {
    ...
    pub const fn ckgatenr(&self) -> utils::Reg<fields::Ckgatenr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x90);
            <utils::Reg<fields::Ckgatenr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
...
pub mod fields {
    ...
    impl Bdcr {
        ...
        #[inline(always)]
        #[doc = "External low-speed oscillator bypass"]
        pub const fn set_lsemod(mut self, val: vals::Lsemod) -> Self {
            self.bits &= !(0x1 << 0x3);
        ...
        #[inline(always)]
        #[doc = "External low-speed oscillator bypass"]
        pub const fn lsemod(self) -> vals::Lsemod {
            let val = ((self.bits >> 0x3) & 0x1) as _;
            unsafe { vals::Lsemod::from_bits_unchecked(val) }
        }
        #[inline(always)]
    ...
    impl Cfgr {
        ...
        pub const fn set_i2ssrc(mut self, val: vals::I2ssrcCfgr) -> Self {
            self.bits &= !(0x1 << 0x17);
        ...
        #[inline(always)]
        #[doc = "I2S clock selection"]
        pub const fn i2ssrc(self) -> vals::I2ssrcCfgr {
            let val = ((self.bits >> 0x17) & 0x1) as _;
            unsafe { vals::I2ssrcCfgr::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "MCO1 prescaler"]
    ...
    impl Dckcfgr {
        ...
        pub const fn set_plli2sdivr(mut self, val: vals::Plli2sdivr) -> Self {
            self.bits &= !(0x1f << 0x0);
            self.bits |= (val.to_bits() as u32 & 0x1f) << 0x0;
            self
        }
        #[inline(always)]
        #[doc = "PLLI2S division factor for SAI1 A/B clock"]
        pub const fn plli2sdivr(self) -> vals::Plli2sdivr {
            let val = ((self.bits >> 0x0) & 0x1f) as _;
            unsafe { vals::Plli2sdivr::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "PLL division factor for SAI1 A/B clock"]
        pub const fn set_plldivr(mut self, val: vals::Plldivr) -> Self {
            self.bits &= !(0x1f << 0x8);
        ...
        #[inline(always)]
        #[doc = "PLL division factor for SAI1 A/B clock"]
        pub const fn plldivr(self) -> vals::Plldivr {
            let val = ((self.bits >> 0x8) & 0x1f) as _;
            unsafe { vals::Plldivr::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_ckdfsdm2asel(mut self, val: vals::Ckdfsdmasel) -> Self {
            self.bits &= !(0x1 << 0xe);
        ...
        #[inline(always)]
        #[doc = "DFSDM2 audio clock selection"]
        pub const fn ckdfsdm2asel(self) -> vals::Ckdfsdmasel {
            let val = ((self.bits >> 0xe) & 0x1) as _;
            unsafe { vals::Ckdfsdmasel::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "DFSDM1 audio clock selection"]
        pub const fn set_ckdfsdm1asel(mut self, val: vals::Ckdfsdmasel) -> Self {
            self.bits &= !(0x1 << 0xf);
        ...
        #[inline(always)]
        #[doc = "DFSDM1 audio clock selection"]
        pub const fn ckdfsdm1asel(self) -> vals::Ckdfsdmasel {
        ...
        pub const fn set_sai1asrc(mut self, val: vals::Saiasrc) -> Self {
            self.bits &= !(0x3 << 0x14);
        ...
        #[inline(always)]
        #[doc = "SAI1-A clock source selection"]
        pub const fn sai1asrc(self) -> vals::Saiasrc {
            let val = ((self.bits >> 0x14) & 0x3) as _;
            unsafe { vals::Saiasrc::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "SAI1 clock source selection"]
        pub const fn set_sai1src(mut self, val: vals::Sai1src) -> Self {
            self.bits &= !(0x3 << 0x14);
            self.bits |= (val.to_bits() as u32 & 0x3) << 0x14;
            self
        }
        #[inline(always)]
        #[doc = "SAI1 clock source selection"]
        pub const fn sai1src(self) -> vals::Sai1src {
            let val = ((self.bits >> 0x14) & 0x3) as _;
            unsafe { vals::Sai1src::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "SAI1-B clock source selection"]
        pub const fn set_sai1bsrc(mut self, val: vals::Saibsrc) -> Self {
            self.bits &= !(0x3 << 0x16);
        ...
        #[inline(always)]
        #[doc = "SAI1-B clock source selection"]
        pub const fn sai1bsrc(self) -> vals::Saibsrc {
            let val = ((self.bits >> 0x16) & 0x3) as _;
            unsafe { vals::Saibsrc::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "SAI2 clock source selection"]
        pub const fn set_sai2src(mut self, val: vals::Sai2src) -> Self {
            self.bits &= !(0x3 << 0x16);
            self.bits |= (val.to_bits() as u32 & 0x3) << 0x16;
            self
        }
        #[inline(always)]
        #[doc = "SAI2 clock source selection"]
        pub const fn sai2src(self) -> vals::Sai2src {
            let val = ((self.bits >> 0x16) & 0x3) as _;
            unsafe { vals::Sai2src::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_i2s1src(mut self, val: vals::I2s1src) -> Self {
            self.bits &= !(0x3 << 0x19);
        ...
        #[inline(always)]
        #[doc = "I2S APB1 clocks source selection (I2S2/3)"]
        pub const fn i2s1src(self) -> vals::I2s1src {
            let val = ((self.bits >> 0x19) & 0x3) as _;
            unsafe { vals::I2s1src::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "I2SSRC"]
        pub const fn set_i2ssrc(mut self, val: vals::I2ssrcDckcfgr) -> Self {
            self.bits &= !(0x3 << 0x19);
            self.bits |= (val.to_bits() as u32 & 0x3) << 0x19;
            self
        }
        #[inline(always)]
        #[doc = "I2SSRC"]
        pub const fn i2ssrc(self) -> vals::I2ssrcDckcfgr {
            let val = ((self.bits >> 0x19) & 0x3) as _;
            unsafe { vals::I2ssrcDckcfgr::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_i2s2src(mut self, val: vals::I2s1src) -> Self {
            self.bits &= !(0x3 << 0x1b);
        ...
        #[inline(always)]
        #[doc = "I2S APB2 clocks source selection (I2S1/4/5)"]
        pub const fn i2s2src(self) -> vals::I2s1src {
            let val = ((self.bits >> 0x1b) & 0x3) as _;
            unsafe { vals::I2s1src::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "SDIO clock source selection"]
        pub const fn set_sdiosel(mut self, val: vals::Sdiosel) -> Self {
            self.bits &= !(0x1 << 0x1c);
        ...
        #[inline(always)]
        #[doc = "SDIO clock source selection"]
        pub const fn sdiosel(self) -> vals::Sdiosel {
            let val = ((self.bits >> 0x1c) & 0x1) as _;
            unsafe { vals::Sdiosel::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_ckdfsdm1sel(mut self, val: vals::Ckdfsdmsel) -> Self {
            self.bits &= !(0x1 << 0x1f);
        ...
        #[inline(always)]
        #[doc = "DFSDM1 Kernel clock selection"]
        pub const fn ckdfsdm1sel(self) -> vals::Ckdfsdmsel {
            let val = ((self.bits >> 0x1f) & 0x1) as _;
            unsafe { vals::Ckdfsdmsel::from_bits_unchecked(val) }
        }
    }
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
    #[repr(transparent)]
    ...
    impl Dckcfgr2 {
        ...
        pub const fn set_spdifrxsel(mut self, val: vals::Spdifrxsel) -> Self {
            self.bits &= !(0x1 << 0x1d);
            self.bits |= (val.to_bits() as u32 & 0x1) << 0x1d;
            self
        }
        #[inline(always)]
        #[doc = "SPDIF clock selection"]
        pub const fn spdifrxsel(self) -> vals::Spdifrxsel {
            let val = ((self.bits >> 0x1d) & 0x1) as _;
            unsafe { vals::Spdifrxsel::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "LPTIM1SEL"]
    ...
    impl Plli2scfgr {
        ...
        pub const fn set_plli2ssrc(mut self, val: vals::Plli2ssrc) -> Self {
            self.bits &= !(0x1 << 0x16);
            self.bits |= (val.to_bits() as u32 & 0x1) << 0x16;
            self
        }
        #[inline(always)]
        #[doc = "PLLI2S entry clock source"]
        pub const fn plli2ssrc(self) -> vals::Plli2ssrc {
            let val = ((self.bits >> 0x16) & 0x1) as _;
            unsafe { vals::Plli2ssrc::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "Main PLL(PLL) and audio PLL (PLLI2S) entry clock source"]
        pub const fn set_pllsrc(mut self, val: vals::Pllsrc) -> Self {
