...
impl Flash {
    ...
    pub const fn acr(&self) -> utils::Reg<fields::Acr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x0);
            <utils::Reg<fields::Acr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    ...
    pub const fn optcr(&self) -> utils::Reg<fields::Optcr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x14);
            <utils::Reg<fields::Optcr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "Flash option control register 1"]
    pub const fn optcr1(&self) -> utils::Reg<fields::Optcr1, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x18);
            <utils::Reg<fields::Optcr1, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "Flash option control register"]
    pub const fn optcr2(&self) -> utils::Reg<fields::Optcr2, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x1c);
            <utils::Reg<fields::Optcr2, utils::RW>>::from_ptr(ptr)
        }
    }
}
pub mod fields {
    ...
    impl Acr {
        ...
        #[inline(always)]
        #[doc = "Latency"]
        pub const fn set_latency(mut self, val: vals::Latency) -> Self {
            self.bits &= !(0xf << 0x0);
        ...
        #[inline(always)]
        #[doc = "Latency"]
        pub const fn latency(self) -> vals::Latency {
            let val = ((self.bits >> 0x0) & 0xf) as _;
            unsafe { vals::Latency::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "Prefetch enable"]
    ...
    impl Cr {
        ...
        #[inline(always)]
        #[doc = "Program size"]
        pub const fn set_psize(mut self, val: vals::Psize) -> Self {
            self.bits &= !(0x3 << 0x8);
        ...
        #[inline(always)]
        #[doc = "Program size"]
        pub const fn psize(self) -> vals::Psize {
            let val = ((self.bits >> 0x8) & 0x3) as _;
            unsafe { vals::Psize::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "Start"]
