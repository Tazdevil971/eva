...
impl Rtc {
    ...
    pub const fn calibr(&self) -> utils::Reg<CalibrBits, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x18);
            <utils::Reg<CalibrBits, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "Alarm register"]
    ...
    pub const fn tafcr(&self) -> utils::Reg<TafcrBits, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x40);
            <utils::Reg<TafcrBits, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
...
#[repr(transparent)]
#[doc = "Calibration register"]
pub struct CalibrBits {
    bits: u32,
}
impl Default for CalibrBits {
    fn default() -> Self {
        unsafe { Self::from_bits_unchecked(0x0) }
    }
}
...
#[repr(transparent)]
#[doc = "Tamper and alternate function configuration register"]
pub struct TafcrBits {
    bits: u32,
}
impl Default for TafcrBits {
    fn default() -> Self {
        unsafe { Self::from_bits_unchecked(0x0) }
    }
}
