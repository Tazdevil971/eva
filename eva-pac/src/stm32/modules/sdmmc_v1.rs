...
impl Sdmmc {
    ...
    pub const fn power(&self) -> utils::Reg<fields::Power, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x0);
            <utils::Reg<fields::Power, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "SDI clock control register"]
    pub const fn clkcr(&self) -> utils::Reg<fields::Clkcr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x4);
            <utils::Reg<fields::Clkcr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "argument register"]
    pub const fn argr(&self) -> utils::Reg<fields::Argr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x8);
            <utils::Reg<fields::Argr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "command register"]
    pub const fn cmdr(&self) -> utils::Reg<fields::Cmdr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0xc);
            <utils::Reg<fields::Cmdr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "command response register"]
    pub const fn respcmdr(&self) -> utils::Reg<fields::Respcmdr, utils::RO> {
        unsafe {
            let ptr = self.ptr.add(0x10);
            <utils::Reg<fields::Respcmdr, utils::RO>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "response 1..4 register"]
    pub const fn respr(&self, idx: usize) -> utils::Reg<fields::ResPxR, utils::RO> {
        assert!(idx < 4);
        unsafe {
            let ptr = self.ptr.add(0x14 + idx * 0x4);
            <utils::Reg<fields::ResPxR, utils::RO>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "data timer register"]
    pub const fn dtimer(&self) -> utils::Reg<fields::Dtimer, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x24);
            <utils::Reg<fields::Dtimer, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "data length register"]
    pub const fn dlenr(&self) -> utils::Reg<fields::Dlenr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x28);
            <utils::Reg<fields::Dlenr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "data control register"]
    pub const fn dctrl(&self) -> utils::Reg<fields::Dctrl, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x2c);
            <utils::Reg<fields::Dctrl, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "data counter register"]
    pub const fn dcntr(&self) -> utils::Reg<fields::Dcntr, utils::RO> {
        unsafe {
            let ptr = self.ptr.add(0x30);
            <utils::Reg<fields::Dcntr, utils::RO>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "status register"]
    pub const fn star(&self) -> utils::Reg<fields::Star, utils::RO> {
        unsafe {
            let ptr = self.ptr.add(0x34);
            <utils::Reg<fields::Star, utils::RO>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "interrupt clear register"]
    pub const fn icr(&self) -> utils::Reg<fields::Icr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x38);
            <utils::Reg<fields::Icr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "mask register"]
    pub const fn maskr(&self) -> utils::Reg<fields::Maskr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x3c);
            <utils::Reg<fields::Maskr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "FIFO counter register"]
    pub const fn fifocnt(&self) -> utils::Reg<fields::Fifocnt, utils::RO> {
        unsafe {
            let ptr = self.ptr.add(0x48);
            <utils::Reg<fields::Fifocnt, utils::RO>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "data FIFO register"]
    pub const fn fifor(&self) -> utils::Reg<fields::Fifor, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x80);
            <utils::Reg<fields::Fifor, utils::RW>>::from_ptr(ptr)
        }
    }
}
pub mod fields {
