...
impl Cr1Bits {
    ...
    pub const fn set_dff(mut self, val: DffVal) -> Self {
        self.bits &= !(0x1 << 0xb);
    ...
    #[inline(always)]
    #[doc = "Data frame format"]
    pub const fn dff(self) -> DffVal {
        let val = ((self.bits >> 0xb) & 0x1) as _;
        unsafe { DffVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
...
impl I2scfgrBits {
    ...
    pub const fn set_i2sstd(mut self, val: I2sstdVal) -> Self {
        self.bits &= !(0x3 << 0x4);
    ...
    #[inline(always)]
    #[doc = "I2S standard selection"]
    pub const fn i2sstd(self) -> I2sstdVal {
        let val = ((self.bits >> 0x4) & 0x3) as _;
        unsafe { I2sstdVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    ...
    pub const fn set_i2scfg(mut self, val: I2scfgVal) -> Self {
        self.bits &= !(0x3 << 0x8);
    ...
    #[inline(always)]
    #[doc = "I2S configuration mode"]
    pub const fn i2scfg(self) -> I2scfgVal {
        let val = ((self.bits >> 0x8) & 0x3) as _;
        unsafe { I2scfgVal::from_bits_unchecked(val) }
    }
    #[inline(always)]
    #[doc = "I2S Enable"]
