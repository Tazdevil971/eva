...
impl Rtc {
    ...
    pub const fn tampcr(&self) -> utils::Reg<fields::Tampcr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x40);
            <utils::Reg<fields::Tampcr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    ...
    #[inline(always)]
    #[doc = "Option register"]
    pub const fn or(&self) -> utils::Reg<fields::Or, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x4c);
            <utils::Reg<fields::Or, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "Backup register"]
