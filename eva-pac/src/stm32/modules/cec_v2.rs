...
impl Cec {
    ...
    pub const fn txdr(&self) -> utils::Reg<fields::Txdr, utils::WO> {
        unsafe {
            let ptr = self.ptr.add(0x8);
            <utils::Reg<fields::Txdr, utils::WO>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "CEC Rx Data Register."]
    pub const fn rxdr(&self) -> utils::Reg<fields::Rxdr, utils::RO> {
        unsafe {
            let ptr = self.ptr.add(0xc);
            <utils::Reg<fields::Rxdr, utils::RO>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
