...
impl Quadspi {
    ...
    pub const fn dcr(&self) -> utils::Reg<fields::Dcr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x4);
            <utils::Reg<fields::Dcr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "status register"]
    ...
    pub const fn dlr(&self) -> utils::Reg<fields::Dlr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x10);
            <utils::Reg<fields::Dlr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    ...
    pub const fn ar(&self) -> utils::Reg<fields::Ar, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x18);
            <utils::Reg<fields::Ar, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "ABR"]
    pub const fn abr(&self) -> utils::Reg<fields::Abr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x1c);
            <utils::Reg<fields::Abr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "data register"]
    ...
    pub const fn psmkr(&self) -> utils::Reg<fields::Psmkr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x24);
            <utils::Reg<fields::Psmkr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "polling status match register"]
    pub const fn psmar(&self) -> utils::Reg<fields::Psmar, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x28);
            <utils::Reg<fields::Psmar, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "polling interval register"]
    pub const fn pir(&self) -> utils::Reg<fields::Pir, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x2c);
            <utils::Reg<fields::Pir, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "low-power timeout register"]
    pub const fn lptr(&self) -> utils::Reg<fields::Lptr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x30);
            <utils::Reg<fields::Lptr, utils::RW>>::from_ptr(ptr)
        }
    }
}
pub mod fields {
