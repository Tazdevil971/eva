...
pub mod fields {
    ...
    impl Cr1 {
        ...
        #[inline(always)]
        #[doc = "CRC length"]
        pub const fn set_crcl(mut self, val: vals::Crcl) -> Self {
            self.bits &= !(0x1 << 0xb);
        ...
        #[inline(always)]
        #[doc = "CRC length"]
        pub const fn crcl(self) -> vals::Crcl {
            let val = ((self.bits >> 0xb) & 0x1) as _;
            unsafe { vals::Crcl::from_bits_unchecked(val) }
        }
        #[inline(always)]
    ...
    impl Cr2 {
        ...
        pub const fn set_frxth(mut self, val: vals::Frxth) -> Self {
            self.bits &= !(0x1 << 0xc);
            self.bits |= (val.to_bits() as u32 & 0x1) << 0xc;
            self
        }
        #[inline(always)]
        #[doc = "FIFO reception threshold"]
        pub const fn frxth(self) -> vals::Frxth {
            let val = ((self.bits >> 0xc) & 0x1) as _;
            unsafe { vals::Frxth::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "Last DMA transfer for reception"]
        pub const fn set_ldma_rx(mut self, val: vals::LdmaRx) -> Self {
            self.bits &= !(0x1 << 0xd);
        ...
        #[inline(always)]
        #[doc = "Last DMA transfer for reception"]
        pub const fn ldma_rx(self) -> vals::LdmaRx {
            let val = ((self.bits >> 0xd) & 0x1) as _;
            unsafe { vals::LdmaRx::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "Last DMA transfer for transmission"]
        pub const fn set_ldma_tx(mut self, val: vals::LdmaTx) -> Self {
            self.bits &= !(0x1 << 0xe);
            self.bits |= (val.to_bits() as u32 & 0x1) << 0xe;
            self
        }
        #[inline(always)]
        #[doc = "Last DMA transfer for transmission"]
        pub const fn ldma_tx(self) -> vals::LdmaTx {
            let val = ((self.bits >> 0xe) & 0x1) as _;
            unsafe { vals::LdmaTx::from_bits_unchecked(val) }
        }
    }
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
    #[repr(transparent)]
    ...
    impl I2scfgr {
        ...
        pub const fn set_i2sstd(mut self, val: vals::Isstd) -> Self {
            self.bits &= !(0x3 << 0x4);
        ...
        #[inline(always)]
        #[doc = "I2S standard selection"]
        pub const fn i2sstd(self) -> vals::Isstd {
            let val = ((self.bits >> 0x4) & 0x3) as _;
            unsafe { vals::Isstd::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_i2scfg(mut self, val: vals::Iscfg) -> Self {
            self.bits &= !(0x3 << 0x8);
        ...
        #[inline(always)]
        #[doc = "I2S configuration mode"]
        pub const fn i2scfg(self) -> vals::Iscfg {
            let val = ((self.bits >> 0x8) & 0x3) as _;
            unsafe { vals::Iscfg::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "I2S Enabled"]
        ...
        pub const fn set_i2smod(mut self, val: vals::Ismod) -> Self {
            self.bits &= !(0x1 << 0xb);
            self.bits |= (val.to_bits() as u32 & 0x1) << 0xb;
            self
        }
        #[inline(always)]
        #[doc = "I2S mode selection"]
        pub const fn i2smod(self) -> vals::Ismod {
            let val = ((self.bits >> 0xb) & 0x1) as _;
            unsafe { vals::Ismod::from_bits_unchecked(val) }
        }
        #[inline(always)]
    ...
    impl Sr {
        ...
        pub const fn set_frlvl(mut self, val: vals::Frlvl) -> Self {
            self.bits &= !(0x3 << 0x9);
        ...
        #[inline(always)]
        #[doc = "FIFO reception level"]
        pub const fn frlvl(self) -> vals::Frlvl {
            let val = ((self.bits >> 0x9) & 0x3) as _;
            unsafe { vals::Frlvl::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "FIFO Transmission Level"]
        pub const fn set_ftlvl(mut self, val: vals::Ftlvl) -> Self {
            self.bits &= !(0x3 << 0xb);
        ...
        #[inline(always)]
        #[doc = "FIFO Transmission Level"]
        pub const fn ftlvl(self) -> vals::Ftlvl {
            let val = ((self.bits >> 0xb) & 0x3) as _;
            unsafe { vals::Ftlvl::from_bits_unchecked(val) }
        }
    }
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
    #[repr(transparent)]
