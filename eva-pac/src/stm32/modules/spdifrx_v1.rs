...
impl Spdifrx {
    ...
    pub const fn ifcr(&self) -> utils::Reg<fields::Ifcr, utils::WO> {
        unsafe {
            let ptr = self.ptr.add(0xc);
            <utils::Reg<fields::Ifcr, utils::WO>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    ...
    pub const fn dir(&self) -> utils::Reg<fields::Dir, utils::RO> {
        unsafe {
            let ptr = self.ptr.add(0x18);
            <utils::Reg<fields::Dir, utils::RO>>::from_ptr(ptr)
        }
    }
}
pub mod fields {
