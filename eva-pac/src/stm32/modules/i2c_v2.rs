...
impl I2c {
    ...
    #[inline(always)]
    #[doc = "Timing register"]
    pub const fn timingr(&self) -> utils::Reg<fields::Timingr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x10);
            <utils::Reg<fields::Timingr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "Timeout register"]
    pub const fn timeoutr(&self) -> utils::Reg<fields::Timeoutr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x14);
            <utils::Reg<fields::Timeoutr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    ...
    #[inline(always)]
    #[doc = "PEC register"]
    pub const fn pecr(&self) -> utils::Reg<fields::Pecr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x20);
            <utils::Reg<fields::Pecr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "Receive data register"]
    pub const fn rxdr(&self) -> utils::Reg<fields::Rxdr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x24);
            <utils::Reg<fields::Rxdr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "Transmit data register"]
    pub const fn txdr(&self) -> utils::Reg<fields::Txdr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x28);
            <utils::Reg<fields::Txdr, utils::RW>>::from_ptr(ptr)
        }
    }
}
pub mod fields {
    ...
    impl Cr2 {
        ...
        pub const fn set_add10(mut self, val: vals::Addmode) -> Self {
            self.bits &= !(0x1 << 0xb);
        ...
        #[inline(always)]
        #[doc = "10-bit addressing mode (master mode)"]
        pub const fn add10(self) -> vals::Addmode {
        ...
        pub const fn set_head10r(mut self, val: vals::Headr) -> Self {
            self.bits &= !(0x1 << 0xc);
        ...
        #[inline(always)]
        #[doc = "10-bit address header only read direction (master receiver mode)"]
        pub const fn head10r(self) -> vals::Headr {
            let val = ((self.bits >> 0xc) & 0x1) as _;
            unsafe { vals::Headr::from_bits_unchecked(val) }
        }
        #[inline(always)]
        ...
        pub const fn set_reload(mut self, val: vals::Reload) -> Self {
            self.bits &= !(0x1 << 0x18);
        ...
        #[inline(always)]
        #[doc = "NBYTES reload mode"]
        pub const fn reload(self) -> vals::Reload {
            let val = ((self.bits >> 0x18) & 0x1) as _;
            unsafe { vals::Reload::from_bits_unchecked(val) }
        }
        #[inline(always)]
        #[doc = "Automatic end mode (master mode)"]
        pub const fn set_autoend(mut self, val: vals::Autoend) -> Self {
            self.bits &= !(0x1 << 0x19);
        ...
        #[inline(always)]
        #[doc = "Automatic end mode (master mode)"]
        pub const fn autoend(self) -> vals::Autoend {
            let val = ((self.bits >> 0x19) & 0x1) as _;
            unsafe { vals::Autoend::from_bits_unchecked(val) }
        }
        #[inline(always)]
    ...
    impl Oar1 {
        ...
        pub const fn set_oa1mode(mut self, val: vals::Addmode) -> Self {
            self.bits &= !(0x1 << 0xa);
            self.bits |= (val.to_bits() as u32 & 0x1) << 0xa;
            self
        }
        #[inline(always)]
        #[doc = "Own Address 1 10-bit mode"]
        pub const fn oa1mode(self) -> vals::Addmode {
            let val = ((self.bits >> 0xa) & 0x1) as _;
            unsafe { vals::Addmode::from_bits_unchecked(val) }
        }
        #[inline(always)]
    ...
    impl Oar2 {
        ...
        pub const fn set_oa2msk(mut self, val: vals::Oamsk) -> Self {
            self.bits &= !(0x7 << 0x8);
        ...
        #[inline(always)]
        #[doc = "Own Address 2 masks"]
        pub const fn oa2msk(self) -> vals::Oamsk {
            let val = ((self.bits >> 0x8) & 0x7) as _;
            unsafe { vals::Oamsk::from_bits_unchecked(val) }
        }
        #[inline(always)]
