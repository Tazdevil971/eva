...
impl Dbgmcu {
    ...
    #[inline(always)]
    #[doc = "IDCODE"]
    pub const fn idcode(&self) -> utils::Reg<fields::Idcode, utils::RO> {
        unsafe {
            let ptr = self.ptr.add(0x0);
            <utils::Reg<fields::Idcode, utils::RO>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    ...
    pub const fn apb1fzr(&self) -> utils::Reg<fields::Apb1fzr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0x8);
            <utils::Reg<fields::Apb1fzr, utils::RW>>::from_ptr(ptr)
        }
    }
    #[inline(always)]
    #[doc = "Debug MCU APB2 Freeze registe"]
    pub const fn apb2fzr(&self) -> utils::Reg<fields::Apb2fzr, utils::RW> {
        unsafe {
            let ptr = self.ptr.add(0xc);
            <utils::Reg<fields::Apb2fzr, utils::RW>>::from_ptr(ptr)
        }
    }
}
pub mod fields {
    ...
    impl Apb1fzr {
        ...
        pub const fn set_i2c1_smbus_timeout(mut self, val: bool) -> Self {
            self.bits &= !(0x1 << 0x15);
        ...
        pub const fn set_i2c2_smbus_timeout(mut self, val: bool) -> Self {
            self.bits &= !(0x1 << 0x16);
        ...
        pub const fn set_i2c3_smbus_timeout(mut self, val: bool) -> Self {
            self.bits &= !(0x1 << 0x17);
        ...
        pub const fn set_i2cfmp_smbus_timeout(mut self, val: bool) -> Self {
            self.bits &= !(0x1 << 0x18);
