...
impl Fmc {
    ...
    pub const fn pmem(&self) -> utils::Reg<fields::Pmem, utils::RW> {
        unsafe {
    ...
    pub const fn patt(&self) -> utils::Reg<fields::Patt, utils::RW> {
        unsafe {
    ...
    pub const fn eccr(&self) -> utils::Reg<fields::Eccr, utils::RO> {
        unsafe {
