...
pub mod cec;
#[path = "../modules/crc_v3.rs"]
pub mod crc;
#[path = "../modules/cryp_v2.rs"]
pub mod cryp;
#[path = "../modules/dac_v2.rs"]
pub mod dac;
#[path = "../modules/dbgmcu_f7.rs"]
pub mod dbgmcu;
...
pub mod dsihost;
#[path = "../modules/eth_v1c.rs"]
pub mod eth;
#[path = "../modules/exti_v1.rs"]
pub mod exti;
#[path = "../modules/flash_f7.rs"]
pub mod flash;
...
pub mod hash;
#[path = "../modules/i2c_v2.rs"]
pub mod i2c;
#[path = "../modules/iwdg_v2.rs"]
pub mod iwdg;
#[path = "../modules/jpeg_v1.rs"]
pub mod jpeg;
#[path = "../modules/lptim_v1a.rs"]
pub mod lptim;
#[path = "../modules/ltdc_v1.rs"]
pub mod ltdc;
#[path = "../modules/mdios_v1.rs"]
pub mod mdios;
#[path = "../modules/otg_v1.rs"]
pub mod otg;
#[path = "../modules/pwr_f7.rs"]
pub mod pwr;
#[path = "../modules/quadspi_v1.rs"]
pub mod quadspi;
#[path = "../modules/rcc_f7.rs"]
pub mod rcc;
#[path = "../modules/rng_v1.rs"]
pub mod rng;
#[path = "../modules/rtc_v2f7.rs"]
pub mod rtc;
...
pub mod spdifrx;
#[path = "../modules/spi_v2.rs"]
pub mod spi;
#[path = "../modules/syscfg_f7.rs"]
pub mod syscfg;
#[path = "../modules/timer_v1.rs"]
pub mod timer;
#[path = "../modules/uid_v1.rs"]
pub mod uid;
#[path = "../modules/usart_v3.rs"]
pub mod usart;
#[path = "../modules/vrefintcal_v1.rs"]
pub mod vrefintcal;
#[path = "../modules/wwdg_v1.rs"]
pub mod wwdg;
pub const UID: uid::Uid = unsafe { <uid::Uid>::from_ptr(0x1ff0f420u64 as _) };
pub const VREFINTCAL: vrefintcal::Vrefintcal =
    unsafe { <vrefintcal::Vrefintcal>::from_ptr(0x1ff0f44au64 as _) };
...
pub const LPTIM1: lptim::Lptim = unsafe { <lptim::Lptim>::from_ptr(0x40002400u64 as _) };
...
pub const CAN3: can::Can = unsafe { <can::Can>::from_ptr(0x40003400u64 as _) };
...
pub const I2C4: i2c::I2c = unsafe { <i2c::I2c>::from_ptr(0x40006000u64 as _) };
...
pub const UART7: usart::Usart = unsafe { <usart::Usart>::from_ptr(0x40007800u64 as _) };
pub const UART8: usart::Usart = unsafe { <usart::Usart>::from_ptr(0x40007c00u64 as _) };
...
pub const SDMMC2: sdmmc::Sdmmc = unsafe { <sdmmc::Sdmmc>::from_ptr(0x40011c00u64 as _) };
...
pub const SDMMC1: sdmmc::Sdmmc = unsafe { <sdmmc::Sdmmc>::from_ptr(0x40012c00u64 as _) };
...
pub const SPI5: spi::Spi = unsafe { <spi::Spi>::from_ptr(0x40015000u64 as _) };
pub const SPI6: spi::Spi = unsafe { <spi::Spi>::from_ptr(0x40015400u64 as _) };
...
pub const LTDC: ltdc::Ltdc = unsafe { <ltdc::Ltdc>::from_ptr(0x40016800u64 as _) };
pub const DSIHOST: dsihost::Dsihost = unsafe { <dsihost::Dsihost>::from_ptr(0x40016c00u64 as _) };
pub const MDIOS: mdios::Mdios = unsafe { <mdios::Mdios>::from_ptr(0x40017800u64 as _) };
...
pub const GPIOI: gpio::Gpio = unsafe { <gpio::Gpio>::from_ptr(0x40022000u64 as _) };
pub const GPIOJ: gpio::Gpio = unsafe { <gpio::Gpio>::from_ptr(0x40022400u64 as _) };
pub const GPIOK: gpio::Gpio = unsafe { <gpio::Gpio>::from_ptr(0x40022800u64 as _) };
...
pub const ETH: eth::Eth = unsafe { <eth::Eth>::from_ptr(0x40028000u64 as _) };
pub const DMA2D: dma2d::Dma2d = unsafe { <dma2d::Dma2d>::from_ptr(0x4002b000u64 as _) };
...
pub const JPEG: jpeg::Jpeg = unsafe { <jpeg::Jpeg>::from_ptr(0x50051000u64 as _) };
pub const CRYP: cryp::Cryp = unsafe { <cryp::Cryp>::from_ptr(0x50060000u64 as _) };
pub const HASH: hash::Hash = unsafe { <hash::Hash>::from_ptr(0x50060400u64 as _) };
pub const RNG: rng::Rng = unsafe { <rng::Rng>::from_ptr(0x50060800u64 as _) };
