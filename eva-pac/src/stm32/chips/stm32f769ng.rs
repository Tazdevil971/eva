...
pub mod wwdg;
pub const UID: uid::Uid = unsafe { <uid::Uid>::from_addr(0x1ff0f420) };
pub const VREFINTCAL: vrefintcal::Vrefintcal =
    unsafe { <vrefintcal::Vrefintcal>::from_addr(0x1ff0f44a) };
...
pub const CAN3: can::Can = unsafe { <can::Can>::from_addr(0x40003400) };
pub const SPI2: spi::Spi = unsafe { <spi::Spi>::from_addr(0x40003800) };
pub const SPI3: spi::Spi = unsafe { <spi::Spi>::from_addr(0x40003c00) };
pub const SPDIFRX1: spdifrx::Spdifrx = unsafe { <spdifrx::Spdifrx>::from_addr(0x40004000) };
...
pub const SDMMC2: sdmmc::Sdmmc = unsafe { <sdmmc::Sdmmc>::from_addr(0x40011c00) };
...
pub const SDMMC1: sdmmc::Sdmmc = unsafe { <sdmmc::Sdmmc>::from_addr(0x40012c00) };
...
pub const SAI2: sai::Sai = unsafe { <sai::Sai>::from_addr(0x40015c00) };
...
pub const MDIOS: mdios::Mdios = unsafe { <mdios::Mdios>::from_addr(0x40017800) };
...
pub const JPEG: jpeg::Jpeg = unsafe { <jpeg::Jpeg>::from_addr(0x50051000) };
pub const RNG: rng::Rng = unsafe { <rng::Rng>::from_addr(0x50060800) };
pub const FMC: fmc::Fmc = unsafe { <fmc::Fmc>::from_addr(0xa0000000) };
