...
pub mod wwdg;
pub const UID: uid::Uid = unsafe { <uid::Uid>::from_addr(0x1ff07a10) };
pub const VREFINTCAL: vrefintcal::Vrefintcal =
    unsafe { <vrefintcal::Vrefintcal>::from_addr(0x1ff07a2a) };
...
pub const AES: aes::Aes = unsafe { <aes::Aes>::from_addr(0x50060000) };
