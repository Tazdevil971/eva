...
pub mod wwdg;
pub const UID: uid::Uid = unsafe { <uid::Uid>::from_ptr(0x1ff07a10u64 as _) };
pub const VREFINTCAL: vrefintcal::Vrefintcal =
    unsafe { <vrefintcal::Vrefintcal>::from_ptr(0x1ff07a2au64 as _) };
...
pub const AES: aes::Aes = unsafe { <aes::Aes>::from_ptr(0x50060000u64 as _) };
