...
pub const CAN3: can::Can = unsafe { <can::Can>::from_addr(0x40006c00) };
...
pub const UART9: usart::Usart = unsafe { <usart::Usart>::from_addr(0x40011800) };
pub const UART10: usart::Usart = unsafe { <usart::Usart>::from_addr(0x40011c00) };
