...
pub const CAN3: can::Can = unsafe { <can::Can>::from_ptr(0x40006c00u64 as _) };
...
pub const UART9: usart::Usart = unsafe { <usart::Usart>::from_ptr(0x40011800u64 as _) };
pub const UART10: usart::Usart = unsafe { <usart::Usart>::from_ptr(0x40011c00u64 as _) };
...
pub const FSMC: fsmc::Fsmc = unsafe { <fsmc::Fsmc>::from_ptr(0xa0000000u64 as _) };
